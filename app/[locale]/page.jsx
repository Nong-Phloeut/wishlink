  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (imageFiles.length > 0) {
        setUploadProgress(t('uploadingPhotos'))
      ...
      setUploadProgress(t('creatingWish'))
                ...
                <Card className="border-stone-200 shadow-sm">
                  <CardContent className="pt-4 pb-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Badge variant="outline" className="text-[9px] text-stone-400 border-stone-200 font-normal">
                        {tc('optional')}
                      </Badge>
                    </div>
                    {videoPreview ? (
