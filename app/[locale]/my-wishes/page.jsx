          ...
          <div className="space-y-3">
            ...
            {wishes.map((wish) => {
              ...
              return (
                ...
                >
                  {/* Left border accent — much subtler than a top bar */}
                  <div
            ...
            <div className="border border-dashed border-stone-200 rounded-2xl p-5 flex flex-col items-center text-center gap-3 mt-1">
              ...
              <div>
                <p className="text-[13px] font-semibold text-stone-700 mb-0.5">
                  {t("myWishes.signInToSync")}
                </p>
                <p className="text-[11px] text-stone-400">
                  Access your wishes from any device
                </p>
              </div>
              <button
                ...
                onClick={async () => {
                  ...
                  supabase.auth.signInWithOAuth({
                    provider: "google",
                    options: {
                      redirectTo: `${window.location.origin}/auth/callback?next=/my-wishes`,
                    },
                  });
                }}
              >
